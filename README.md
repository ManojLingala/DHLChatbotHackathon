# Acebot - DHL Assistive CHATBot

A prototype chat-bot application to demonstrate use-cases for DHL order management and frequent customer queries. 
...
* Visual Studio 2017. 
* Bot Builder SDK (Nu-Get Package)
* Adaptive Card (Nu-Get Package)
* Azure Subscription
